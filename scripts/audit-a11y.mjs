...
export const PAGES = [
  ...
  '/progress.html',
  '/sandbox.html',
  // Python for Data is generated by its own template (build-data-course.cjs),
  // so it is a page shape of its own: a lesson, and a unit page.
  '/data/unit-1/reading-a-csv-file.html',
  '/data/unit-4.html',
  '/unit-test.html?unit=3&course=data',
];
