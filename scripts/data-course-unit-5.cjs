    ...
    lessons: [
      ...
      /* ---------------------------------------------------------------- 3 */
      {
        ...
        sections: [
          {
            ...
            steps: [
              ...
              },
              {
                ...
                note: 'This also matters for joining. If one file keeps <code>"007"</code> as text and another reads it as the number 7, merging them raises an error in unit 8 — and converting the number back with <code>astype(str)</code> gives <code>"7"</code>, which matches nothing and raises nothing.',
              },
            ],
          },
          {
        ...
        questions: [
          ...
          { id: 'd5-swn-4', prompt: 'One file keeps ids as text like "007"; another reads them as numbers. Why does that matter?',
            choices: ['It does not', 'The leading zeros are gone, so the ids no longer match even as text', 'It doubles the memory', 'It changes the row order'], answer: 1,
            explain: 'Joining an int key to a text key raises, and converting 7 back to text gives "7", not "007" — a join that then matches nothing without any error.' },
        ],
      },
      /* ---------------------------------------------------------------- 4 */
      {
