...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="none">
  <style>
    @media (prefers-reduced-motion: no-preference) {
      .orbit-track { animation: orbit-dash 28s linear infinite; }
      .lunar-satellite { transform-origin: 310px 300px; animation: satellite-orbit 45s linear infinite; }
      .lunar-stars { animation: star-breathe 5s ease-in-out infinite alternate; }
    }
    @keyframes orbit-dash { to { stroke-dashoffset: -240; } }
  ...
  <ellipse class="orbit-track" cx="310" cy="310" rx="279" ry="89" transform="rotate(-29 310 310)" stroke="#a490c2" stroke-width="1.2" stroke-dasharray="3 9" opacity=".55"/>
  <g class="lunar-stars" fill="#a490c2">
