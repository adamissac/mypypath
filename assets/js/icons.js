(function () {
  ...
  var ICONS = {
    ...
    sparkles: '<path d="m12 3-1.9 5.8L4 12l5.1 3.2L12 21l1.9-5.8L19 12l-5.1-3.2z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/>',
  ...
  window.PyIcons = { svg: svg, el: iconEl, ICONS: ICONS };
})();
